...
function Produto() {
    ...
    useEffect(() => {
        async function fetchItensPadaria() {
            try {
                const response = await axios.get(`http://3.85.53.213:8080/itens-comercio/${selectedPadariaId}`);
    ...
    const enviarPedido = async () => {
        ...
        try {
            const response = await axios.post('http://3.85.53.213:8080/pedidos', data);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                  const response = await axios.post('http://3.85.53.213:8080/pedidos/salvar-pedidos', data);
