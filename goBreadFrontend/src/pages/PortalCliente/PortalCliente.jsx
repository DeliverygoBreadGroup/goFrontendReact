...
function PortalCliente() {
    ...
    useEffect(() => {
        async function fetchCliente() {
            try {
                ...
                const response = await axios.get(`http://3.82.51.193:8080/clientes/${idCliente}`);
    ...
    async function handleDeletePedido(pedidoId) {
        try {
            ...
            if (confirmed) {
                await axios.delete(`http://3.82.51.193:8080/pedidos/${pedidoId}`);
                ...
                if (revertConfirmed) {
                    await axios.post(`http://3.82.51.193:8080/pedidos/reverter-delete`, { pedidoId });
    ...
    async function handleRevertAllDeleted() {
        try {
            ...
            if (confirmed) {
                ...
                await axios.post('http://3.82.51.193:8080/pedidos/reverter-delete', { deletedPedidoIds });
                window.location.reload();
            }
        } catch (error) {
