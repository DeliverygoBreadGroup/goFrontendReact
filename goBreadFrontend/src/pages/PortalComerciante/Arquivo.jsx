...
function Arquivo() {
    ...
    const handleDownload = async () => {
        try {
            ...
            const response = await axios.get(`http://3.85.53.213:8080/comercios/download/clientes-txt/${idComercio}`, {
                responseType: 'blob',
            });
    ...
    const handleUpload = async () => {
        try {
            ...
            await axios.post('http://3.85.53.213:8080/comercios/upload/produtos-txt', formData, {
                headers: {
